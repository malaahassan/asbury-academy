...
function AssignmentTab({type, name, time, status, grade}) {
  
  return (
      <tr>
          <td><div className="dashboard-table-task">
              <div className="dashboard-table-task-title">
                  { type == "test" && 
                      <div title="Test" className="dashboard-table-task-icon" style={{background: "rgb(222, 114, 88)"}}>
                  ...
                  {type == "video" && 
                    <div title="Video" className="dashboard-table-task-icon" style={{background: "rgb(59, 180, 127)"}}>
                  ...
                  {type == "file" && 
                    <div title="File" className="dashboard-table-task-icon" style={{background: "#673AB7"}}>
            ...
            <td>{grade ? grade : ""}{/*"—"*/}</td>
            <td>
              <div className={`dashboard-table-status-card ${status == "completed" || status == "graded" ? "green" : status == "overdue" ? "red" : "yellow"}`}>
