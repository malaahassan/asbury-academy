...
const EditAccountWindow = ({myaccount, refetch, onClose, user_id, firstName, lastName, email, phoneNumber, birthday, gender, profile, cover, group, dropdown_groups}) => {
    ...
    const userData = useRef({
        ...
        function addGrade(){
            const arr = [...selectedTeachingClasses, {value: dropdown_groups[0].value, displayName: dropdown_groups[0].displayName}];
            setSelectedTeachingClasses(arr)
        }
                ...
                (response) => {
                    if(myaccount){
                        setLogData((prevState) => ({
                            ...
                            group: userData.current.group,
                            user_first_name: userData.current.firstName,
                            user_last_name: userData.current.lastName
                        }));
        ...
        return ReactDOM.createPortal(
            <>
            { editPictureWindow && <EditAccountPictureWindow onClose={onPhotoDiscard} previewPfp={pfpBlob.current}  previewCover={coverBlob.current} firstName={firstName} type={photoType} setCoverPhoto={setCoverPhoto}  setProfilePhoto={setProfilePhoto}/>}
            <div className="window-container">
                <div className="window" style={{ width: '600px', alignItems: 'start', minHeight:'75vh'}}>
                    <div className='pfp-cover-wrapper'>
                        
                        <div ref={coverImageRef} className='cover-photo' style={{ backgroundImage: `url(${cover})`, position: 'relative' }}>
                        ...
                        <div className="pfp-wrapper" style={{ position: 'relative'}}>
                            <div className="pfp-second-wrapper">
                                ...
                                <img  ref={profileImageRef}  src={profile} alt="" className='pfp' />
                            </div>
                    ...
                    <form className="edit-account-form">
                        <div  className='edit-account-form-block'>
                            {/* <h1 className='edit-account-header'>Personal</h1> */}
                            ...
                            <Field label="Group" value={group} onChange={(e)=>{userData.current.group = e.target.value}} type={'group'}  />
