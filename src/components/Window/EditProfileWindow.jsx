...
const EditProfileWindow = ({ onClose, previewPfp, previewCover, firstName, type, setCoverPhoto, setProfilePhoto }) => {
    ...
    return ReactDOM.createPortal(
        <div className='window-container'>
            <div className={ type === 'profile' ? 'window edit-profile-window pfp-preview' : 'window edit-profile-window cover-preview'  } ref={windowRef}>
                <h2 className='edit-profile-header'>Edit your {type} picture</h2>
